 ...
 * Original file: /home/roxana/Desktop/3dupb/yaxim-master/src/org/yaxim/androidclient/service/IXMPPRosterService.aidl
 */
...
case TRANSACTION_sendPresenceRequest:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
java.lang.String _arg1;
_arg1 = data.readString();
this.sendPresenceRequest(_arg0, _arg1);
reply.writeNoException();
return true;
}
...
@Override public void sendPresenceRequest(java.lang.String user, java.lang.String type) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_sendPresenceRequest, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_sendPresenceRequest = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
...
public void sendPresenceRequest(java.lang.String user, java.lang.String type) throws android.os.RemoteException;
